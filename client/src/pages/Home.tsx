...
export default function Home() {
  ...
  return (
    <>
      {/* Home Section */}
      <section id="home" className="pt-8 pb-12 relative bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-6 relative z-10">
              <div className="inline-block bg-red-100 text-primary px-4 py-1 rounded-full text-sm font-medium animate-pulse">
                {t('emergency.title')}
              </div>
              <h2 className="text-4xl font-bold text-[#004A9F] leading-tight">
                {t('home.title')}
              </h2>
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                ...
                <Link href="/hospitals">
                  <div className="bg-[#004A9F] hover:bg-[#0064D6] text-white px-6 py-4 rounded-lg font-medium transition-all duration-300 transform hover:translate-y-[-4px] hover:shadow-lg inline-flex items-center gap-2 cursor-pointer">
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/emergency">
              <div className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer w-[100px]">
                <div className="bg-red-100 p-3 rounded-full mb-2">
                  <AlertCircle className="w-5 h-5 text-primary" />
                </div>
                <span className="text-sm text-center">Protocols</span>
              </div>
            </Link>
            <Link href="/hospitals">
              <div className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer w-[100px]">
                ...
                <span className="text-sm text-center">Hospitals</span>
              </div>
            </Link>
            <Link href="/contacts">
              <div className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer w-[100px]">
                ...
                <span className="text-sm text-center">Contacts</span>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section id="contacts" className="py-10 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#004A9F] mb-3">
      ...
      <section id="hospitals" className="py-10 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#004A9F] mb-3">
              {t('hospitals.title')}
      ...
      <section id="emergency" className="py-10 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#004A9F] mb-3">
              {t('protocols.title')}
      ...
      <section id="offline-access" className="py-10 bg-white">
        <div className="container mx-auto px-4">
          <div className="bg-blue-50 p-6 rounded-2xl shadow-sm">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2 text-sm bg-white px-4 py-2 rounded-full text-[#004A9F] shadow-sm">
